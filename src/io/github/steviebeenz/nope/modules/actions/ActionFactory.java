...
import io.github.steviebeenz.nope.modules.actions.actions.AddVLAction;
import io.github.steviebeenz.nope.modules.actions.actions.AnimationAction;
import io.github.steviebeenz.nope.modules.actions.actions.BanAction;
import io.github.steviebeenz.nope.modules.actions.actions.BanwaveAction;
import io.github.steviebeenz.nope.modules.actions.actions.CancelAction;
import io.github.steviebeenz.nope.modules.actions.actions.CommandAction;
import io.github.steviebeenz.nope.modules.actions.actions.CustomAction;
import io.github.steviebeenz.nope.modules.actions.actions.DelayAction;
import io.github.steviebeenz.nope.modules.actions.actions.IsDevCheck;
import io.github.steviebeenz.nope.modules.actions.actions.KickAction;
import io.github.steviebeenz.nope.modules.actions.actions.LogAction;
import io.github.steviebeenz.nope.modules.actions.actions.MessageAction;
import io.github.steviebeenz.nope.modules.actions.actions.MessagePlayerAction;
import io.github.steviebeenz.nope.modules.actions.actions.NotDevCheck;
import io.github.steviebeenz.nope.modules.actions.actions.PingCheck;
import io.github.steviebeenz.nope.modules.actions.actions.RandomCheck;
import io.github.steviebeenz.nope.modules.actions.actions.SetVLAction;
import io.github.steviebeenz.nope.modules.actions.actions.TPSCheck;
import io.github.steviebeenz.nope.modules.actions.actions.VLActionCheck;
	...
	public AbstractAction createAction(String data) {
		...
		if (data.startsWith("log:")) {
			try {
				...
				return new LogAction(plugin, LogAction.Type.valueOf(logType), message);
		...
		if (data.startsWith("animation:")) {
			try {
				...
				return new AnimationAction(plugin, AnimationManager.AnimationType.valueOf(animType), customGroup);
			} catch (IllegalArgumentException e) {
